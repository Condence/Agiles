...
router.post(`/api/${config.api.version}/asistencia`, usuarioController.postAsistencia);  // Publico
...
router.get(`/api/${config.api.version}/users`,  usuarioController.getUsuarios); // Privado
